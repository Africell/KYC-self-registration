...
const en = {
  ...
  side_drop_here: "Drop image here",
  ...
  // ── Challenge labels & instructions ───────────────────────────────────────────
  challenge_center_label: "Face Forward",
  challenge_center_instruction: "Look directly at the camera.",
  challenge_lookLeft_label: "Look Left",
  challenge_lookLeft_instruction: "Slowly turn your head to your left.",
  ...
  challenge_moveCloser_instruction: "Move your face closer to the camera.",

  // ── Liveness hints ────────────────────────────────────────────────────────────
  hint_center_face: "Center your face inside the frame.",
  hint_side_photo: "Turn your head to the right for the side photo.",
  hint_one_person: "Only one person should be in frame.",
  hint_move_into_oval: "Move your face into the oval guide.",
  hint_face_detected_ready: "Face detected! Click 'I'm Ready' to begin.",
  hint_gesture_loading: "Almost ready… preparing gesture detection.",
  hint_no_face: "No face detected. Move closer or improve lighting.",
  hint_center_holding: "✓ Hold still… ({{current}}/{{required}})",
  hint_center_hold: "Face centered — hold still",
  hint_look_camera: "Face the camera directly",
  hint_checking_quality: "Hold still — checking quality…",
  hint_hold_position: "✓ Hold that position!",
  hint_good_turn: "✓ Good turn — hold it!",
  hint_turn_left_progress: "Almost there — keep turning left ({{pct}}%)",
  hint_turn_left: "Turn your head to the left",
  hint_turn_right_progress: "Almost there — keep turning right ({{pct}}%)",
  hint_turn_right: "Turn your head to the right",
  hint_closer_hold: "✓ Close enough — hold still!",
  hint_closer_progress: "Almost there — {{pct}}% closer, keep going",
  hint_closer: "Move your face closer to the camera",
  hint_left_hand_raised: "✓ Left hand raised!",
  hint_right_hand_raised: "✓ Right hand raised!",
  hint_nod_detected: "✓ Head nod detected!",
...
const fr: typeof en = {
  ...
  side_drop_here: "Déposez l'image ici",
  ...
  sig_loading: "Traitement de l'image...",
  ...
  // ── Challenge labels & instructions ───────────────────────────────────────────
  challenge_center_label: "Regardez la caméra",
  challenge_center_instruction: "Regardez directement la caméra.",
  challenge_lookLeft_label: "Regardez à gauche",
  challenge_lookLeft_instruction: "Tournez lentement la tête à gauche.",
  ...
  challenge_moveCloser_instruction: "Rapprochez votre visage de la caméra.",

  // ── Liveness hints ────────────────────────────────────────────────────────────
  hint_center_face: "Centrez votre visage dans le cadre.",
  ...
  hint_checking_quality: "Restez immobile — vérification de la qualité…",
  hint_hold_position: "✓ Maintenez cette position !",
  hint_good_turn: "✓ Bon virage — maintenez !",
  hint_turn_left_progress: "Presque — continuez à tourner à gauche ({{pct}}%)",
  hint_turn_left: "Tournez la tête à gauche",
  hint_turn_right_progress: "Presque — continuez à tourner à droite ({{pct}}%)",
  hint_turn_right: "Tournez la tête à droite",
  hint_closer_hold: "✓ Suffisamment proche — restez immobile !",
  hint_closer_progress: "Presque — {{pct}}% plus proche, continuez",
  hint_closer: "Rapprochez votre visage de la caméra",
  hint_left_hand_raised: "✓ Main gauche levée !",
  hint_right_hand_raised: "✓ Main droite levée !",
  hint_nod_detected: "✓ Hochement de tête détecté !",
